...
```
libraryDependencies += "com.github.music-of-the-ainur" %% "mongodb-almaren" % "0.0.8-2.4"
...
```
spark-shell --master local[*] --packages "com.github.music-of-the-ainur:almaren-framework_2.12:0.9.8-2.4,com.github.music-of-the-ainur:mongodb-almaren_2.12:0.0.8-2.4,org.mongodb.spark:mongo-spark-connector_2.11:2.4.4"
```
